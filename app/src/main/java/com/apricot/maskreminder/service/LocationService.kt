...
/* THIS SERVICE INCLUDES 5-STEP LOCATION VERIFICATION TEST
* WHICH MEANS, AFTER THE SERVICE GETS THE FIRST INFO OF 'THE USER OUTSIDE'
* IT DOES NOT DIRECTLY NOTIFY HIM, BEFORE THAT, IT CHECKS THE LOCATION
...
* BECAUSE NORMAL REQUESTER SO SLOW FOR THIS (7 SECONDS PER REQUEST)
* NORMAL REQUESTER BEING CALLED AFTER FINISHING THE VERIFICATION.
*
* THIS IS MADE TO PREVENT INCORRECT LOCATION DATA WHICH CAN BE SEEN VERY OFTEN
 */
